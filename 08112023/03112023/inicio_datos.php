    ...
    <?php foreach($resultado as $row) { ?>
        <div class="product">
          <picture>
            <?php 
            $id = $row['id'];
            $imagen = "imginicio/productos/". $id ."/arroz.png";
          ...
          <div class="button">
            ...
            <a class="xd" href="#">Comprar</a>
          </div>
        </div>
        <?php  } ?>
        <div class="product">
          <picture>
            <img src="image/frijoles.png" alt="">
          </picture>
          <div class="detail">
            <p>
              <b>Frijoles</b><br>
              <small>Nuevas promociones</small>
            </p>
            <samp>$34.00</samp>
          </div>
          <div class="button">
        ...
        <div class="product">
          <picture>
            <img src="image/manzana.png" alt="">
          </picture>
          <div class="detail">
            <p>
              <b>Manzana</b><br>
              <small>Nuevos catalogos</small>
            </p>
            <samp>$12.00</samp>
          </div>
          <div class="button">
        ...
        <div class="product">
          <picture>
            <img src="image/manzanaverde.png" alt="">
          </picture>
          <div class="detail">
            <p>
              <b>Manzana Verde</b><br>
              <small>Pidela hoy</small>
            </p>
            <samp>$25.00</samp>
          </div>
          <div class="button">
